            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-0">
                    ...
                    <div class="d-flex justify-content-end mb-3 gap-2 d-print-none">
                        <a href="../manager/print-evaluation.php?id=<?php echo $row['evaluation_id']; ?>" target="_blank" class="btn btn-sm btn-primary">
                    ...
                    <div class="table-responsive mb-4">
                        <table class="table table-sm table-bordered mb-0">
                            ...
                            <tbody class="small">
                                ...
                                <tr>
                                    <td colspan="4" class="bg-light italic"><strong>Notes:</strong> <?php echo e($row['career_growth_details']); ?></td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
