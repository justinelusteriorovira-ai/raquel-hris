...
<div class="d-flex justify-content-between align-items-center mb-4">
    <p class="text-muted mb-0">Review evaluation criteria and scoring weights for this template.</p>
    <a href="<?php echo BASE_URL; ?>/supervisor/templates.php" class="btn btn-secondary">
