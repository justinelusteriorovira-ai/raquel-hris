...
if (empty($display_avatar)) {
    $role_img = 'staff.png';
    if ($_SESSION['role'] === 'Admin') $role_img = 'admin.png';
    elseif ($_SESSION['role'] === 'HR Manager') $role_img = 'manager.png';
...
switch ($_SESSION['role']) {
    ...
    case 'HR Manager':
        $sidebar_menus = [
            ...
            'APPROVALS' => [
                ['icon' => 'fas fa-route', 'label' => 'Career Movement', 'url' => BASE_URL . '/manager/career-movement-approval.php', 'page' => 'career-movement-approval.php', 'class' => 'coming-soon'],
            ],
            'ANALYTICS' => [
    ...
    case 'HR Staff':
        $sidebar_menus = [
            ...
            'VIEWING' => [
                ...
                ['icon' => 'fas fa-route', 'label' => 'Career History', 'url' => BASE_URL . '/staff/career-history.php', 'page' => 'career-history.php', 'class' => 'coming-soon'],
            ],
            'NOTIFICATIONS' => [
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <img src="<?php echo BASE_URL; ?>/assets/img/logo/logo.png" alt="Raquel Pawnshop Logo" style="width: 50px; height: 50px; border-radius: 12px; object-fit: cover; margin-bottom: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.2); background: white; border: 2px solid rgba(255,255,255,0.1);">
        ...
        <?php foreach ($sidebar_menus as $label => $items): ?>
            ...
            <?php foreach ($items as $item): ?>
                <?php
                    ...
                    if (!empty($item['class'])) $classes .= ($classes ? ' ' : '') . $item['class'];
                ?>
                <a href="<?php echo $item['url']; ?>" class="<?php echo $classes; ?>" title="<?php echo e($item['label']); ?>">
...
<header class="top-navbar">
    <div class="d-flex align-items-center gap-3">
        ...
        <div class="navbar-logo d-flex align-items-center gap-2">
            <img src="<?php echo BASE_URL; ?>/assets/img/logo/logo.png" alt="Logo" style="width: 35px; height: 35px; border-radius: 8px; object-fit: cover;">
    ...
    <div class="nav-right">
            ...
            <div class="dropdown-menu dropdown-menu-end notification-dropdown">
                ...
                <?php else: ?>
                    <?php foreach ($notifications as $notif): ?>
                        <a href="<?php echo e($notif['link'] ?? '#'); ?>" class="notification-item <?php echo $notif['is_read'] ? '' : 'unread'; ?>">
        ...
        <div class="dropdown user-dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><span class="dropdown-item-text"><small class="text-muted"><?php echo e($_SESSION['role']); ?></small></span></li>
