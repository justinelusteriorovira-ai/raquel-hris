        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                ...
                <div class="modal-body p-4 pt-0">
                    ...
                    <!-- Career Growth -->
                    <?php if(!empty($sub['desired_position']) || !empty($sub['career_growth_details'])): ?>
                    <div class="section-premium-label mb-3 mt-5">
                    ...
                    <div class="p-3 bg-light rounded-3 mb-4 border-start border-4 border-info">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                ...
                                <div class="fw-bold text-primary" style="font-size: 1.1rem;"><?php echo e($sub['desired_position'] ?? 'N/A'); ?></div>
                            </div>
                            <div class="col-sm-6 text-sm-end">
                                <small class="text-uppercase text-muted fw-bold d-block mb-1">Target Date</small>
                                <div class="fw-bold"><?php echo $sub['target_date'] ? formatDate($sub['target_date']) : 'N/A'; ?></div>
                            </div>
                        </div>
                        <?php if(!empty($sub['career_growth_details'])): ?>
                            <hr class="my-3 opacity-25">
                            <div class="x-small text-muted"><span class="fw-bold">Notes:</span> <?php echo e($sub['career_growth_details']); ?></div>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
